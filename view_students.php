	...
	for($k=1;$k<13;$k++)
	{
		if(!empty($std[$k]["A"])) {
			...
			foreach($std[$k]["A"] as $myvalA) {
				...
				$student_term."&id=".$myvalA[0]."'>Edit</a>
				</td>";
				echo "<td width='20%' style='border:1px solid black;'>
				<a href='delete_student.php?school_name=".$school_name."&term=".
				$student_term."&id=".$myvalA[0]."'>Delete</a>
				</td>";
				echo "</tr>";
			}
			echo "</table>";
		...
		if(!empty($std[$k]["B"])) {
			...
			foreach($std[$k]["B"] as $myvalB) {
				...
				echo "<td width='20%' style='border:1px solid black;'>
				<a href='edit_student.php?school_name=".$school_name."&term=".
				$student_term."&id=".$myvalB[0]."'>Edit</a>
				</td>";
				echo "<td width='20%' style='border:1px solid black;'>
				<a href='delete_student.php?school_name=".$school_name."&term=".
				$student_term."&id=".$myvalB[0]."'>Delete</a>
				</td>";
				echo "</tr>";
			}
			echo "</table>";
		...
		if(!empty($std[$k]["C"])) {
			...
			foreach($std[$k]["C"] as $myvalC) {
				...
				echo "<td width='20%' style='border:1px solid black;'>
				<a href='edit_student.php?school_name=".$school_name."&term=".
				$student_term."&id=".$myvalCA[0]."'>Edit</a>
				</td>";
				echo "<td width='20%' style='border:1px solid black;'>
				<a href='delete_student.php?school_name=".$school_name."&term=".
				$student_term."&id=".$myvalC[0]."'>Delete</a>
				</td>";
				echo "</tr>";
			}
			echo "</table>";
		...
		if(!empty($std[$k]["D"])) {
			...
			foreach($std[$k]["D"] as $myvalD) {
				...
				echo "<td width='20%' style='border:1px solid black;'>
				<a href='edit_student.php?school_name=".$school_name."&term=".
				$student_term."&id=".$myvalD[0]."'>Edit</a>
				</td>";
				echo "<td width='20%' style='border:1px solid black;'>
				<a href='delete_student.php?school_name=".$school_name."&term=".
				$student_term."&id=".$myvalD[0]."'>Delete</a>
				</td>";
				echo "</tr>";
			}
			echo "</table>";
		...
		if(!empty($std[$k]["E"])) {
			...
			foreach($std[$k]["E"] as $myvalE) {
				...
				echo "<td width='20%' style='border:1px solid black;'>
				<a href='edit_student.php?school_name=".$school_name."&term=".
				$student_term."&id=".$myvalE[0]."'>Edit</a>
				</td>";
				echo "<td width='20%' style='border:1px solid black;'>
				<a href='delete_student.php?school_name=".$school_name."&term=".
				$student_term."&id=".$myvalE[0]."'>Delete</a>
				</td>";
				echo "</tr>";
			}
			echo "</table>";
